...
| Bluetooth | works under postmarketOS | pairs and connects: encrypted classic (BR/EDR) link to a Mac, service discovery works; audio devices and file transfer untested |
